          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <div className="relative rounded-2xl overflow-hidden mb-8 shadow-md bg-[#f5f0e8]" style={{aspectRatio:'16/9'}}>
                <Image src="/anvaya-core-01-hero-1080p-day-night.png" alt="Anvaya Smart contactless AI baby monitor India — breathing, SpO2 and cry monitoring" fill className="object-contain" sizes="(max-width: 768px) 100vw, 50vw" priority />
              </div>
